    ...
    >
      <div slot="page1">
        ...
        <p>
          ...
          braying or barking sounds and soft snorting sounds. The position of
          their ears, how wide open their eyes are, and whether they show their
          teeth all send a signal. For example, ears flat back means trouble, or
        ...
        <div
          ...
          :class="{
            ...
            valid: isFormFieldValid('name'),
          }"
        >
          <div class="input-group">
            <input v-model="name" type="text" name="name" required="required" />
            <va-icon
              name="fa fa-exclamation-triangle error-icon icon-right input-icon"
            />
