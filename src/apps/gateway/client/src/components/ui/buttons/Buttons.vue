<template>
  <div class="buttons">
    <div class="row">
      <div class="flex xs12">
        <va-card class="larger-padding" :title="$t('buttons.types')">
          <div class="row">
            <div class="flex">
      ...
      <div class="flex xs12">
        <va-card class="larger-padding" :title="$t('buttons.size')">
          <div class="row">
            <div class="flex">
      ...
      <div class="flex xs12">
        <va-card class="larger-padding" :title="$t('buttons.tags')">
          <div class="row">
            <div class="flex">
      ...
      <div class="flex xs12">
        <va-card class="larger-padding" :title="$t('buttons.advanced')">
          <div class="row">
            <div class="flex">
      ...
      <div class="flex xs12">
        <va-card class="larger-padding" :title="$t('buttons.colors')">
          <div class="row">
            <div class="flex">
      ...
      <div class="flex xs12">
        <va-card class="larger-padding" :title="$t('buttons.buttonGroups')">
          <div class="row">
            ...
            <div class="flex xs12 xl6">
              <va-button-group>
                ...
                <va-button flat color="gray" icon="entypo entypo-user">
                  Second</va-button
                >
                <va-button flat color="gray" icon="ion ion-ios-alarm">
                  Third</va-button
                >
              </va-button-group>
            </div>
      ...
      <div class="flex xs12">
        <va-card class="larger-padding" :title="$t('buttons.buttonToggles')">
          <div class="row">
      ...
      <div class="flex xs12">
        <va-card class="larger-padding" :title="$t('buttons.pagination')">
          <div class="row">
            <div class="flex xs12 xl6">
              <va-pagination
                v-model="activePage"
            ...
            <div class="flex xs12 xl6">
              <va-pagination
                ...
                :visible-pages="3"
                :icon="{
                  boundary: 'fa fa-bell-slash',
                  direction: 'fa fa-volume-off',
                }"
                :icon-right="{
                  boundary: 'fa fa-bell',
                  direction: 'fa fa-volume-up',
                }"
                color="success"
              />
            </div>
      ...
      <div class="flex xs12">
        <va-card class="larger-padding" :title="$t('buttons.buttonsDropdown')">
          <div class="row">
            <div class="flex">
